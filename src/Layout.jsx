...
const Layout = () => {
  ...
  return (
    <>
      ...
      <main className=" relative bg-bkg-light dark:bg-bkg min-h-screen  flex flex-col mx-auto border-text-light dark:border-opacity-50 dark:border-accent max-[1150px]:border-none border-x-2 border-opacity-30 font-medium dark:font-normal pb-[34px]">
