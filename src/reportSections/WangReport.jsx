        ...
        <PhotoProvider loadingElement={<div className="loader"></div>}>
          <article>
            <p>
              ...
              podstawie wycinanki od GPM, ale po dokładniejszym zapoznaniu się z
              nią stwierdziłem, że zbyt mocno odbiega ona od oryginału. Przede
              wszystkim świątynia jest tam za szeroka, a w wielu miejscach
              wymiary są przekłamane. Gdy szukałem zdjęć w internecie, natknąłem
              się na rysunki, których skany w wysokiej rozdzielczości znalazłem
              na stronie Muzeum Architektury w Berlinie:{" "}
              <a
            ...
            <p>
              Na podstawie tych trzech rysunków i zdjęć z internetu, postaram
              się wykonać cały model. Będę wszystko przerysowywał w photoshopie.
              Tak wygląda porównanie podstawy GPM (po lewej) z rysunkiem na
              stronie muzeum.
            </p>
            ...
            <p>
              Model z GPM przedstawia budowlę w ciemniejszej, wcześniejszej
              wersji, a ja wykonam ją w wersji jaśniejszej, aktualnej.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              dociskałem każdy fragment po kolei małym dłutkiem, spiłowanym do
              odpowiedniego kąta.
            </p>
            ...
            <p>
              Ściany malowałem dwiema warstwami ochry żółtej, później bardzo
              ...
              musiałem po wyschnięciu niekture miejsca ponownie docisnąć. Okna
              są wydrukowane na papierze fotograficznym, a parapety są z paska
            ...
            <p>
              Oto główne wejście do świątyni, jeszcze bez drzwi i wszystkich
              detali.
            </p>
            ...
            <p>
              ...
              grubszego i cieńszego, a w górnej części słupków wyciąłem żyletką
              rowek.
            </p>
            ...
            <p>
              ...
              umbrą paloną i na koniec przecierałem jaśniejszym kolorem.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              kawałków odpowiednio uformowanej balsy.
            </p>
            ...
            <p>
              ...
              zdjęciach, że deski są trochę wklęsłe, więc spiłowałem środek
              każdej deski papierem ściernym.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Górną część z wyciętymi łukami wykonałem na podstawie starych
              fotografii, aktualnie chyba już tego nie ma, ciężko stwierdzić bo
              to miejsce przysłaniają rynny.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Wykonałem resztę ścianek i kolejne boczne wejście do świątyni.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              Najpierw wkleiłem tekturę i wyrównałem wszystko szpachlówką. W
              dolnej części dachów wkleiłem paski 1.5 mm, by wyrównać ściany z
              kolumnami. Pobrudziłem też ściany świątyni różnymi odcieniami,
              żeby nie wyglądały tak idealnie jak nowe.
            </p>
            ...
            <p>
              Następnie przygotowałem sobie teksturę dachu, którą wyciąłem z
              tego zdjęcia i wyprostowałem w photoshopie. Złączyłem ze sobą
              cztery fragmenty w jedną dużą teksturę.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Dachówki wycinałem i naklejałem paskami od dołu do góry, przerwy
              pomiędzy dachówkami wytłoczyłem igłą. Wcześniej jeszcze nakleiłem
              karton z teksturą dachu, żeby mieć jakiś punkt odniesienia przy
              naklejaniu pasków.
            </p>
            ...
            <p>
              Na zaokrągleniach docinałem i wklejałem pojedyncze fragmenty, co
              okazało się bardzo żmudnym procesem.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              wycięciem dachówek nie podkleiłem ich jeszcze kartonem, bo wyszły
              trochę za płasko.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Zakleiłem główny dach. Najpierw wkleiłem 2mm tekturę i na nią
              odpowiednio przygotowaną tekturę 0.5 mm. Tak samo zrobiłem z
              mniejszym dachem, który pokryłem już gontem.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Skleiłem kopułę nad absydą. Kształt wyrysowałem w google sketchup
              i rozłożyłem w programie pepekura. Po sklejeniu wyciąłem po jednym
            ...
            <p>
              Pomyślałem, że spróbuję zrobić imitację blachy jaką pokryty jest
              dach, więc zacząłem oklejać kopułę kawałkami papieru, które
              naklejałem kolejno na zakładkę. Okleiłem tak całą kopułę od dołu
              do góry, oraz przykleiłem paski nad oknami. Następnie przykleiłem
              druciki w miejscu łączenia blach.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              zamalowałem czarną farbą i ponownie pomalowałem kolorem, tylko
              teraz przecierając prawie suchym pędzlem.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              W taki sam sposób wykonałem mniejszą kopułkę. Nie będę jej na
              razie przyklejał, bo krzyżyk można by łatwo ułamać.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Tak prezentuje się całość, chociaż teraz widzę, że nie do końca
              trafiłem z odcieniem, bo powinien być bardziej zielonkawy.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Następnie zabrałem się za sklejanie wieży na głównym dachu. Miałem
              sporo problemów z wykonaniem narożnych kolumn, mają średnicę
              raptem 4mm i ciągle rozpadały mi się przy nacinaniu, lub przy
              malowaniu. Trochę pomogło nasączanie ich klejem cyjanoakrylowym
              przed pomalowaniem.
            </p>
            ...
            <p>
              Na ściankach wieży są takie oto wzorki. Początkowo chciałem je
              zrobić tylko płaską teksturą, ale jednak udało mi się je
              powycinać.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Właściwie miałem jeszcze zrobiony górny segment wieży, ale nie
              byłem z niego zadowolony, poprawiałem go kilka razy, a i tak
              zawsze gdzieś było krzywo, więc zrobiłem go od nowa.
            </p>
            ...
            <p>
              Pokryłem resztę dachów gontem i na krawędziach dachów nakleiłem
              paski. Przykleiłem też górną część wieży.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Zabrałem się za składanie przykościelnej dzwonnicy. Podzieliłem ją
              na trzy segmenty. Najpierw sklejałem środek z tektury i potem na
              ścianki naklejałem styrodur o grubości 2 mm. Na styrodurze wyryłem
              igłą wzór kamieni. W górnej części dzwonnicy gdzie kamień jest
              bardziej nierówny, dociskałem do syroduru papier ścierny o różnych
              gradacjach.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Tak będzie wyglądać cała dzwonnica, na razie postawiona na sucho.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              dolnej części paski. W ten sam sposób wykonałem kamienne przejście
              między kościołem a dzwonnicą.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Dzwonnica pomalowana. Wkleiłem też okna i drzwi. Zegary dorobię
              później, bo będzie przy nich więcej pracy.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Zbudowałem zadaszenie w przejściu między kościołem, a dzwonnicą.
              Tym razem kolumny zwinąłem z papieru. Pod daszkiem wkleiłem diodę
              smd.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              planuję umieścić wokół budowli, powinny być dalej, niż początkowo
              myślałem, żeby ładnie podświetlały dachy. Powiększyłem więc
              podstawę, dodając po bokach 3cm i 1cm z przodu i z tyłu.
            </p>
            ...
            <p>
              ...
              naklejałem druciki o średnicy 0.2 i 0.3 mm. i całość
            ...
            <p>
              Po dodaniu wskazówek i pomalowaniu tak się prezentują, na razie
              nie będę ich jeszcze przyklejał.
            </p>
            ...
            <p>
              Zrobiłem kolejne daszki, krzyże, paski ze wzorkami, które będą
              wzdłuż krawędzi dachów oraz rzeźby smoków, które będą na ich
              końcach. To już wszystkie brakujące elementy samej budowli, na
              razie jeszcze ich nie przyklejam.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Następnie zabrałem się za kostkę brukową wokół kościoła, którą
              wykonam ze styroduru.
            </p>
            ...
            <p>
              Elementy kostki brukowej zrobione. Nie jestem do końca zadowolony
              z efektu, bo wyszły trochę za duże szpary pomiędzy kamieniami.
              Mogłem wyryć ten wzorek cieńszą igłą, albo zrobić odrobinę większe
              kamienie, ale tak już zostawię. Przed końcowym malowaniem całość
              przeszlifowałem papierem ściernym.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Kilka lat temu nauczyłem się podstaw programowania płytek Arduino
              i pomyślałem, że wykorzystam to w modelu do sterowania
              oświetleniem. Użyję do tego płytki Arduino Nano. Sterowanie
              oświetleniem podzielę na trzy części: diody wokół budowli, diodę
              nad wejściem oraz diodę pod daszkiem między kościołem a wieżą.
            </p>
            <p>
              Na początek złożyłem do testów układ na płytce stykowej i nie
              obyło się bez kilku problemów. Planuję zrobić sterowanie pilotem i
              gdy testowałem jego działanie, pilot czasem działał, czasem nie,
              albo działał tylko z bliska. Wymieniałem baterię, sprawdzałem, czy
              wszystko łączy, ale nie było poprawy.
            </p>
            <p>
              Długo szukałem przyczyny problemu, aż w końcu okazało się, że
              winny jest stabilizator, do którego podłączyłem odbiornik.
              Odbiornik musi dostawać napięcie równe 5 V, a mój stabilizator
              podawał tylko 4,7 V. Po wymianie wszystko działa.
            </p>
            <p>
              Taki pilot RF ma bardzo dobry zasięg, więc spokojnie mogę ukryć
              odbiornik we wnętrzu modelu. Nie trzeba też celować pilotem w
              odbiornik, żeby złapał sygnał.
            </p>
            ...
            <p>
              Na wypadek gdyby jakiś układ zawiódł i trzeba by go wymienić,
              wlutowałem najpierw gniazda do których mogę wpinać arduino i
              odbiornik RF.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Po uporządkowaniu kabli tak to wygląda. Oczywiście tych kabelków
              będzie więcej. Na razie podłączyłem diodę nad wejściem i obok
              wieży.
            </p>
            ...
            <p>
              Oświetleniem będzie można również sterować przyciskami na modelu.
            </p>
            ...
            <p>
              ...
              zmniejszania jasności, przycisk zwiększania jasności, przycisk
              zmiany trybu, diody oznaczające aktywny tryb. <br />
              <strong>Prawa strona:</strong> przycisk resetu arduino, gniazdo
              micro USB, gniazdo DC zasilania.
            </p>
            ...
            <p>
              ...
              Uporządkowałem kabelki i dodałem kilka opisów, żeby łatwiej się w
              tym połapać, gdyby trzeba było coś poprawić. Spód modelu zasłonię
              tekturą, która będzie trzymać się na magnesach.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              przedniej części podstawy wnękę i umieściłem w niej 6 diod led.
              Później nakleję na to wydrukowany biały napis na czarnym tle.
            </p>
            ...
            <p>
              ...
              przygotowałem podłoże, smarując je wikolem i posypując wysuszoną
              ziemią.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Do wykonania trawnika użyłem jasnej trawki 2.5mm, zmieszanej z
              niewielką ilością ciemnej.
            </p>
            ...
            <p>
              ...
              generator jonów ujemnych. Taki generator można kupić na AliExpress
              za około 30 zł. Wcześniej próbowałem użyć układu z elektrycznej
              łapki na owady, ale tam moc była zdecydowanie za słaba. Generator
              pracuje na 12 V, ja zasilam go 9 V i działa bez problemu.
            </p>
            ...
            <p>
              ...
              <strong>mod podge</strong>, jedną część kleju na trzy części wody.
              Po utrwaleniu trawka trochę ciemnieje, więc wziąłem to wcześniej
              pod uwagę i nie przyciemniałem jej za bardzo.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Obok kościoła znajduje się wysokie drzewo. Wykonałem dwa takie
              drzewka, ponieważ z pierwszego nie byłem do końca zadowolony. W
              pierwszym (po lewej) dałem więcej trawki na gałęziach, co
              sprawiło, że wyglądało trochę jakby „puchate”. W drugim drzewku
              zrobiłem więcej gałęzi, posypałem mniej trawki i z tego drzewka
            ...
            <p>
              ...
              skracałem w górnej części. Pień posmarowałem wikolem i posypałem
              ziemią, by uzyskać fakturę kory. Następnie gałęzie zagęściłem,
              przyklejając do nich włosie ze starego pędzla, pocięte na około
              7mm kawałki (nie miałem trawki o tej długości). Całość pomalowałem
              brązową farbą w spreju. Spryskałem drzewko klejem i posypałem
              zieloną trawką 2.5mm.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              nagrobków. Kamienne nagrobki zrobiłem ze styroduru, drugi w dolnym
              rzędzie z balsy, a resztę z papieru.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              nasączonych klejem <strong>CA</strong>. Musiałem zrobić w sumie
              ponad 60cm takiego płotka.
            </p>
            ...
            <p>
              ...
              postanowiłem wykorzystać do tego <strong>komosę ciernistą</strong>{" "}
              (inaczej pianę morską). Na allegro pod nazwą{" "}
              <strong>seafoam trees</strong>, można kupić za około 45 zł pudełko
              takiej komosy. W środku jest kilkanaście dużych i małych gałązek.
              Te największe mają ponad 20 cm długości.
            </p>
            ...
            <p>
              Z kilku mniejszych gałązek uformowałem krzaczki i pomalowałem je
              brązową farbą w spreju.
            </p>
            ...
            <p>
              Jako posypki użyłem zwykłych trocin, które przesiałem przez drobne
              sitko i zabarwiłem na kilka różnych odcieni zieleni.
            </p>
            ...
            <p>
              By przykleić posypkę, najpierw nakładałem pędzelkiem na końcówki
              gałęzi <strong>wikol</strong> i posypywałem ciemniejszą zielenią.
              Potem spryskiwałem całość rozcieńczonym wikolem i ostrożnie
              posypywałem jaśniejszym odcieniem zieleni, tak by nie nasypać na
              pień. Na koniec posypałem jeszcze górną część krzaczka
              najjaśniejszym odcieniem zieleni.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              dorobiłem jeszcze jeden nagrobek, który wcześniej przeoczyłem. Z
              lewej strony w rogu dodałem diodę, która będzie to miejsce
              podświetlać, więc wokół modelu jest teraz w sumie 11 diod LED.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              W kilku miejscach umieściłem diody na słupkach, żeby świeciły znad
              płotka.
            </p>
            ...
            <p>
              Okleiłem podstawę czarnym kartonem i dodałem oznaczenia przycisków
              i gniazd.
            </p>
            ...
            <p>
              Tak jak wcześniej pisałem zrobiłem podświetlany napis z przodu
              modelu.
            </p>
