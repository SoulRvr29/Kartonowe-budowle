              ...
              {currentPage === 1 && (
                <>
                  <p>
                    ...
                    najlepiej łączyć ze sobą, patrząc na linie z przodu noska,
                    bo gdy sklejałem je równo z łączeniami, wychodziły
                    przesunięcia. Niektóre paski musiałem skrócić o 1 mm.
                    Ogólnie modele z tej strony nie są idealnie spasowane i
                  ...
                  <p>
                    Tak wygląda wnętrze noska Starshipa z dodatkowymi
                    zbiornikami na paliwo (środek) oraz zbiornikami COPV (czarne
                    zbiorniki po bokach). Można by się pokusić o wycięcie
                    otworów w kratownicach, ale zdecydowałem, że we wnętrzu
                    rakiety, którego i tak normalnie nie widać, nie będę dodawał
                    detali. Kratownice też średnio do siebie pasują i musiałem
                  ...
                  <p>
                    ...
                    wtedy zauważyłem, że ta podstawa pod nie powinna być
                    wklejona płycej, bo wewnętrzna oklejka była dłuższa dla
                    druku 3d, w którym można było wydrukować i wkleić całą
                    podstawę z silnikami. Więc musiałem wkleić tę podstawę
                    ponownie, a jako że miałem już przyklejone elementy na
                    ściankach to podstawę rozciąłem na trzy części i tak po
                    kawałku wklejałem.
                  </p>
                  <div className="report-photo-group">
                  ...
                  <p>
                    ...
                    podnosić i opuszczać, przykładając do nich magnes.
                    Wewnętrzny otwór na drzwi był za szeroki o jakieś 5 mm, więc
                  ...
                  <p>
                    ...
                    będą ruchome. Zamocowałem je na prostym zawiasie - jedna
                  ...
                  <p>
                    Nad flapami Starshipa wkleiłem osłony. W projekcie te
                    elementy były za małe i musiałem je powiększyć o jakieś 10%
              ...
              {currentPage === 2 && (
                <>
                  <p>
                    ...
                    jest 10, ale potem dodałem jeszcze po dwa). Magnesy
                    wklejałem jeszcze przed całkowitym wycięciem elementów z
                    tektury. Stronę, która będzie widoczna wyrównywałem
                    szpachlą.
                  </p>
                  <div className="report-photo-group">
                  ...
                  <p>
                    ...
                    wzmocnienia po wewnętrznej stronie wkleiłem w kilku
                  ...
                  <p>
                    W dolnej części boostera, sekcja silnikowa sprawiła mi
                    trochę problemów. Wewnętrzny pasek jest za długi o kilka
                    milimetrów. Po zewnętrznej stronie osłony silników musiałem
                    wklejać "na oko", bo pola pod nie narysowane są krzywo i nie
                    pasują kształtem. Te "kostki" nad osłonami to już w ogóle
                    nie pasują i musiałem je rozcinać na trzy fragmenty i jakoś
                    dopasować.
                  </p>
                  <div className="report-photo-group">
                  ...
                  <p>
                    ...
                    wewnętrznych silników. Wewnętrzną stronę dysz pomalowałem
                  ...
                  <p>
                    ...
                    dodam od siebie więcej elementów. Wykonałem więc rury z
                    drutu cynowego 1 mm, które biegną wzdłuż boostera po obu
                    stronach (w sumie około 2m długości). Dodałem też wypukłe
                    usztywnienia boostera w formie pasków oraz różnego rodzaju
                    włazy, rury i inne drobne detale.
                  </p>
                  <p>
                    Tak prezentuje się gotowy model. Aby zdjęcie całego modelu
                    było w większej rozdzielczości, zmontowałem je z kilku ujęć
