        ...
        <PhotoProvider loadingElement={<div className="loader"></div>}>
          <article>
            ...
            <p>
              ...
              separacji (hot staging ring). Musiałem więc wykonać kolejne dwie
              pary pierścieni z magnesami. Jako że łączą całego Starshipa z
              boosterem, postanowiłem użyć do tego więcej magnesów - po 12 z
              każdej strony (na zdjęciu w górnej parze jest 10, ale potem
              dodałem jeszcze po dwa). Magnesy wklejałem jeszcze przed
              całkowitym wycięciem elementów z tektury. Stronę, która będzie
              widoczna wyrównywałem szpachlą.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Skleiłem główną część boostera. Ma długość 66cm i jest połączona z
              trzech segmentów. Następnie w górnej części wkleiłem pierścień z
              magnesami.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Następnie zabrałem się za sklejanie sterów kratowych (grid fins).
              Ich dolna, kwadratowa część łączy się bezproblemowo. Górną część
              musiałem rozcinać w kilku miejscach i poprawiać.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Tak wygląda gotowa górna część boostera. Stery kratowe trzymają
              się na magnesach i można nimi obracać.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              ...
              problemów. Wewnętrzny pasek jest za długi o kilka milimetrów. Po
              zewnętrznej stronie osłony silników musiałem wklejać "na oko", bo
              pola pod nie narysowane są krzywo i nie pasują kształtem. Te
              "kostki" nad osłonami to już w ogóle nie pasują i musiałem je
              rozcinać na trzy fragmenty i jakoś dopasować.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Następnie skleiłem 33 dysze silników Raptor i osłony wewnętrznych
              silników. Wewnętrzną stronę dysz pomalowałem (tak samo jak stery
              kratowe) kolorem gunmetal.
            </p>
            <div className="report-photo-group">
            ...
            <p>
              Na tym mógłbym już zakończyć budowę, ale zdecydowałem, że dodam od
              siebie więcej elementów. Wykonałem więc rury z drutu cynowego 1
              mm, które biegną wzdłuż boostera po obu stronach (w sumie około 2m
              długości). Dodałem też wypukłe usztywnienia boostera w formie
              pasków oraz różnego rodzaju włazy, rury i inne drobne detale.
            </p>
            <p>
              Tak prezentuje się gotowy model. Aby zdjęcie całego modelu było w
              większej rozdzielczości, zmontowałem je z kilku ujęć za pomocą
              programu do składania panoram.
            </p>
            <div className="report-photo-group">
              <PhotoView src="https://www.modelcraft.pl/models/starship_s30/build/full-res/starship_s30-b58.webp">
                <LazyLoadImage
                  className="report-photo"
                  src="https://www.modelcraft.pl/models/starship_s30/build/thumb/starship_s30-thumb-b58.webp"
