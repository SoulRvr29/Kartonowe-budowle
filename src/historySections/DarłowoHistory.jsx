...
const DarłowoHistory = ({ id }) => {
  ...
  const photosSrc = [
    "models/latarnie_morskie/darlowo/darlowo-photo-1.webp",
    "models/latarnie_morskie/darlowo/darlowo-photo-2.webp",
    "models/latarnie_morskie/darlowo/darlowo-photo-3.webp",
  ];
        ...
        >
          <article className="px-8 max-sm:px-4">
            ...
            <p className="opacity-75 m-0">
              Źródło:{" "}
              <a
                href="https://pl.wikipedia.org/wiki/Latarnia_Morska_Dar%C5%82owo"
                target="_blank"
              >
                wikipedia
              </a>
