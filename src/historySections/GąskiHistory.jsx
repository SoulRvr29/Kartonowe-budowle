...
const GąskiHistory = ({ id }) => {
  ...
  ///////////////////////// PHOTOS SCRIPTS /////////////////////////
  const photosSrc = [
    "models/latarnie_morskie/gaski/gaski-photo-1.webp",
    "models/latarnie_morskie/gaski/gaski-photo-2.webp",
    "models/latarnie_morskie/gaski/gaski-photo-3.webp",
    "models/latarnie_morskie/gaski/gaski-photo-4.webp",
  ];
  const photosTitle = [
        ...
        >
          <article className="px-8 max-sm:px-4">
            ...
            <p className="opacity-75 m-0">
              Źródło:{" "}
              <a
                href="https://pl.wikipedia.org/wiki/Latarnia_Morska_G%C4%85ski"
                target="_blank"
              >
                wikipedia
              </a>
