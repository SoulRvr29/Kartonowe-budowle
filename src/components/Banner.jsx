  ...
  return (
    <>
      ...
      >
        ...
        {bannerState && (
          <div className="absolute flex gap-1 max-sm:gap-0 top-3 left-4 max-sm:top-1 max-sm:left-2 z-[15]">
            {!controlShow ? (
              <>
                {/* control show button */}
                <button
                  className="drop-shadow-[1px_2px_1px_var(--bkg)] opacity-50 dark:opacity-30 dark:hover:opacity-100 hover:opacity-100 transition-opacity "
                  onClick={(e) => {
                ...
                >
                  <GoGear size={22} fill="var(--text-light)" />
                </button>
              </>
            ) : (
              <>
                ...
                <button
                  ...
                  className="max-sm:px-1 drop-shadow-[1px_2px_1px_var(--bkg)] opacity-50 dark:opacity-30 dark:hover:opacity-100 hover:opacity-100 transition-opacity "
                >
        ...
        >
          {bannerState && (
            <h2
              className="banner-text opacity-0 absolute z-[15] bottom-4 left-8 text-xl text-text-light drop-shadow-[1px_2px_1px_var(--bkg)] font-bold name-fade max-md:text-base max-md:left-4 max-md:bottom-2"
              style={
                animRunning
          ...
          <div className="grid justify-center">
            ...
            {bannerState && (
              <img
                ...
                className="banner-img opacity-0 relative bottom-[11rem] place-self-center w-screen min-w-max max-sm:min-w-[900px] max-sm:mb-[3rem] max-sm:ml-[-4rem] "
                style={
                  animRunning
                    ? { animationPlayState: "running" }
                    : { animationPlayState: "paused" }
