...
function App() {
  ...
  return (
    <>
      <header className="relative px-4 max-[400px]:px-1 flex justify-between items-center dark:bg-transparent bg-white bg-opacity-30 ">
        {/* left side */}
        <div className="mt-1">
          <button>
            <Link to="/Kartonowe-budowle/" title="home" reloadDocument>
              <svg
        ...
        <div className="flex gap-2 max-sm:ga mt-1">
          ...
          {/* font size icon */}
          <button title="font size" onClick={() => fontSizeChange()}>
            <svg
