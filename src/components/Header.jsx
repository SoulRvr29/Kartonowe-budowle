        ...
        <div className="flex gap-2 z-10 -mb-1 max-[460px]:mb-1 max-[460px]:gap-4 ">
          <button className="mb-1">
            <Link to="/Kartonowe-budowle/" title="strona główna" reloadDocument>
              <svg
                className="hover:brightness-150 opacity-50 dark:opacity-100 transition-all"
                height="1.1em"
        ...
        <div className="flex gap-2 z-10 -mb-1 max-[460px]:mb-1 max-[460px]:gap-4">
          ...
          <button title="ustawienia">
            <svg
              ...
              height="1.1em"
              fill="var(--text-dark)"
              className="hover:brightness-150 transition-all opacity-50 dark:opacity-100 "
          ...
          >
            <svg
              className={
                darkMode
                  ? "hover:brightness-150 drop-shadow-[0_-2px_7px_white]transition-color opacity-50 dark:opacity-100 "
                  : "hover:brightness-150 drop-shadow-[0_-2px_6px_white] fill-white transition-color opacity-100 dark:opacity-100  "
              }
              xmlns="http://www.w3.org/2000/svg"
              height="1.1em"
              viewBox="0 0 384 512"
