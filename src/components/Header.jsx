        ...
        <div className="flex gap-2 mt-1">
          ...
          <button title="ustawienia">
            <svg
              ...
              height="1.1em"
              fill="var(--text-dark)"
              className="hover:brightness-150 transition-all opacity-50 dark:opacity-100 max-sm:h-[0.9rem] "
          ...
          >
            <svg
              className={
                darkMode
                  ? "hover:brightness-150 drop-shadow-[0_-2px_7px_white]transition-color opacity-50 dark:opacity-100 max-sm:h-[0.9rem] "
                  : "hover:brightness-150 drop-shadow-[0_-2px_6px_white] fill-white transition-color opacity-100 dark:opacity-100 max-sm:h-[0.9rem] "
              }
              xmlns="http://www.w3.org/2000/svg"
              height="1.1em"
              viewBox="0 0 384 512"
          ...
          <a title="wyślij mail" href="mailto:pawelc29@interia.pl">
            <svg
              className="hover:brightness-150 transition-all opacity-50 dark:opacity-100 max-sm:h-[0.95rem]"
              xmlns="http://www.w3.org/2000/svg"
              height="1.25em"
              viewBox="0 0 512 512"
              fill="var(--text-dark)"
