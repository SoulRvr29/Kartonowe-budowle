...
const Settings = ({
  ...
  return (
    <>
      <div className="max-sm:grid w-screen h-screen fixed top-0 left-0 bg-black bg-opacity-30 z-20 "></div>
      <div className="settings grid w-80 max-sm:right-auto max-sm:mx-4 max-sm:w-[calc(100%-2rem)] max-sm:top-7 select-none absolute top-[62px] right-8 dark:bg-text-dark bg-text-light rounded-xl drop-shadow-[5px_5px_10px_rgba(0,0,0,0.5)] border-2 dark:border-text-light dark:border-opacity-40 z-20 px-4 pt-1 pb-4 dark:text-text-light text-text-dark">
        <div className={!confirm ? " visible" : " invisible"}>
          ...
          <ul className=" font-medium grid gap-y-1 mt-2">
            {/* KOLORYSTYKA */}
            <li className="rounded-md  flex justify-between bg-text-dark bg-opacity-20 p-1 px-2 dark:bg-text-light dark:bg-opacity-20">
              Kolorystyka:{" "}
              <button
                className="border-2 dark:border-text-dark w-24 rounded-lg px-2 dark:hover:text-text-dark dark:hover:bg-text-light hover:bg-text-dark hover:text-text-light transition-colors"
                onClick={() => modeChange()}
              >
            ...
            {/* KARTY NAWIGACJI */}
            <li className="rounded-md max-sm:hidden flex justify-between bg-text-dark bg-opacity-20 p-1 px-2 dark:bg-text-light dark:bg-opacity-20">
              Karty nawigacji:{" "}
              <button
                className="border-2 dark:border-text-dark w-24 rounded-lg px-2 dark:hover:text-text-dark dark:hover:bg-text-light hover:bg-text-dark hover:text-text-light transition-colors"
