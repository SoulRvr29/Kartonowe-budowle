        ...
        >
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 384 512"
              fill="white"
              className="fixed justify-self-end hover:bg-accent-2 rounded-full  aspect-square p-[2px] bg-accent drop-shadow-lg border-2  m-8"
              onClick={(e) => {
                e.stopPropagation();
            ...
            {photoSize === false ? (
              ...
              <div className="grid">
                ...
                <svg
                  ...
                  viewBox="0 0 320 512"
                  fill="white"
                  className="fixed hover:bg-accent-2 rounded-full  aspect-square p-[2px] bg-accent drop-shadow-lg border-2 top-1/2 ml-8"
                  onClick={(e) => {
                    e.stopPropagation();
                ...
                <svg
                  ...
                  viewBox="0 0 320 512"
                  fill="white"
                  className="fixed justify-self-end hover:bg-accent-2 rounded-full  aspect-square p-[2px] bg-accent drop-shadow-lg border-2 top-1/2 mr-8"
                  onClick={(e) => {
                    e.stopPropagation();
                    let nr = Number.parseInt(photoId);
