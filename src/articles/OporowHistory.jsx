        ...
        >
          <article className="px-8">
            ...
            <p>
              ...
              pierwszy wymieniono w źródłach w 1363 roku. Budowę pierwszego
              dworu około roku 1350 przypisuję się Stefanowi, pierwszemu znanemu
            ...
            <p>
              W budynku tym mieszkali również goście Oporowskich, a w
              późniejszych latach także służba. Dwór funkcjonował, gdy stał już
              zamek. Mogli tam przebywać goście Władysława Oporowskiego –
            ...
            <p>
              ...
              Bogusław (kanonik i archidiakon gnieźnieński), syn Stefana,
              „pojawił się jako świadek na dokumencie wystawionym przez
              Kazimierza Wielkiego”. To właśnie z ojcem Bogusława, Stefanem
              (chorążym i sędzią łęczyckim), łączy się wybudowanie pierwszego
              dworu Oporowskich. Z kolei Bogusław pojawił się też jako
              scholastyk w dokumencie notarialnym z 1376 i w 1396, w dokumencie
              wydanym przez arcybiskupa Dobrogosta. Miasto miało zostać założone
              na gruntach dawnej wsi. Autorzy nie są zgodni co do tego, kiedy
              założony „pierwotny” Oporów, mogło to być przed połową XII
              stulecia, lub też później.
            </p>
            <p>
              Kolejne siedziby rodowe wznosili już najznamienitsi
              przedstawiciele rodziny. Mikołaj Oporowski był bratankiem i
              spadkobiercą Bogusława, synem Włodzimierza (podstolego i sędziego
              łęczyckiego). Za jego życia powstała prawdopodobnie jedynie wieża
              zamkowa. Budowę rezydencji rodzinnej dokończył Władysław
              Oporowski. Karierę w duchowieństwie zaczynał po studiach na
            ...
            <p>
              ...
              jezierzyskiemu. Józef od 1748 tytułował się kasztelanem witebskim,
              a od 1752 – wojewodą witebskim. W 1737 wziął ślub z Antoniną
              Teresą Ogińską, córką Karola, starosty dorsuńskiego. Córki Jana
              nie uczestniczyły w podziale majątku, a były to: Anna (zm. 1756),
              małżonka Tomasza Szczawińskiego, starosty gąbińskiego oraz
              Katarzyna (1708-1778), od 1729 w klasztorze benedyktynek. Akt ten
              określono jako zapis „dyspozycyjny i dokumentacyjny”, do ksiąg
              miejskich w Grodnie wniesiony 15 marca 1740. Dobra koronne
              Sołłohubów miały w tym czasie wartość około 300000 zł polskich,
              zarządzał nimi Józef, natomiast Antoni otrzymał ziemie na Litwie.
              Majątek był oddłużony, co stało się dzięki działaniom Jana
              Sołłohuba, podczas jego władania okolicznymi terenami.
            </p>
            <p>
              Po śmierci Jana Sołłohuba w 1748, dwaj bracia zdecydowali o innym
              podziale ziem, niż ten, o którym zdecydował ich ojciec. Każdy z
              nich wziął część terenów zarówno z terenu Korony, jak i z Litwy.
              Dla zachowania zasady równego działu, Józef miał wypłacić
              Antoniemu 10272 zł polskich 10 gr. Józef Sołłohub dążył do
              zwiększania majątku, w 1752 nabył wieś Wola Owsiana, w 1754 „dwie
              części” w Żychlinie, natomiast w 1762 – Dobrzewy. W 1777 roku
              kupił ostatni swój nabytek – wsie Świechów i Kurów.
            </p>
            <p>
              ...
              komnatę wieży zachodniej z komnatami domu mieszkalnego.
              Zlikwidowano most zwodzony, w miejsce którego powstał zapewne
              nasyp ziemny, połączony mostem stałym z przeciwległym brzegiem
              fosy. Miały zostać wtedy powiększone otwory okienne na piętrze,
              zamurowano arkadę ostrołukową w przedsionku kaplicy, by zamontować
              tam nieduże okno. Prawdopodobnie rozebrano wtedy również budynek
              dobudowany przez Tarnowskich, ponadto wzniesiono fundament pod
              schody, prowadzące do ganku na piętro.
            </p>
            <p>
              ...
              nabycia majątku zastawił go, w 1786 roku ów majątek przejął
              posesor zastawny, Adam Wodzyński – łowczy orłowski, który władał
              Oporowem do około 1790 roku. W 1792 roku dobra oporowskie przeszły
            ...
            <p>
              ...
              owym czasie klasycyzm. Z tego okresu mogły pochodzić resztki
              tynków, pokrywające do 1962 roku część elewacji zamku oraz
              kanelowane pilastry, nałożone na gotyckie arkadowanie zachodniej
              elewacji baszty, które łączyło kamienne kroksztyny. W tym czasie
              przebywał w Oporowie mistrz murarski z warszawy, Marcin Lewicki,
              zmarł on z powodu „oberwania”.
            </p>
            <p>
              ...
              spodnia murów wieży zapadła się w ziemię, i z tego powodu nową
              wieżę pomurowano, co dotąd znać widoczne”. Piwnica stała się
              znacznie płytsza, pokryto ją sklepieniem żagielkowym na gurtach,
              zniknęły „obszerne lochy”. Być może wzmocniono w tym czasie
              również mury zamku, przez dostawienie dwóch skarp narożnych w
              dwóch narożnikach i przesklepienie dwóch piwnic domu mieszkalnego,
              podobnie, jak w wieży.
            </p>
            <p>
              Po śmierci matki, majątkiem dysponował jej syn, Aleksander
              Oborski, były pułkownik wojsk polskich, oddawszy dobra oporowskie
              w dzierżawę. Zamek i okolice przejął w roku 1839 Tomasz Orsetii
            ...
            <p>
              ...
              przedstawione są zbiory z różnych epok, gromadzone, przez wiele
              lat. Niewielka część z nich dotyczy bezpośrednio byłych
