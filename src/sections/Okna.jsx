  ...
  return (
    <>
      <header className="article-header bg-opacity-20 bg-white dark:bg-text-dark dark:bg-opacity-30 mb-2 bg-gradient-to-b from-transparent via-[rgba(255,255,255,0.2)] dark:via-[rgba(0,122,204,0.15)] to-transparent z-10 ">
        <hr className="w-full m-0 dark:bg-accent-2 bg-accent-4" />
        <h2 className="article-header font-Calistoga tracking-widest text-center text-3xl  max-sm:text-xl font-semibold pt-1 px-2  dark:text-accent-2 text-accent-4 dark:drop-shadow-[2px_2px_1px_rgba(0,0,0,0.5)] drop-shadow-[1px_0px_0px_rgba(0,0,0,0.5)]">
          Wykonanie okien <br />
        </h2>
        <hr className="w-full mb-0 dark:bg-accent-2 bg-accent-4" />
      </header>
      <article>
        <p>
          ...
          consequuntur accusamus. Dolore, repellendus nam, debitis reprehenderit
          ut laborum, est magnam saepe obcaecati eos veniam neque aliquam?
          Architecto eum ab assumenda nam. Modi vel fugit dolorum illo
          doloremque! Voluptates numquam, illum reiciendis esse atque ipsa
          quibusdam cumque iusto blanditiis architecto autem. Asperiores
          architecto expedita consectetur exercitationem, nihil illo modi aut
          tempore adipisci pariatur voluptatem eaque dolores sunt quasi. Eum
          nemo voluptatum autem facere ab debitis quidem et vel recusandae
          voluptatem illo quas deserunt error id, assumenda aperiam voluptas
          neque placeat sit natus. Excepturi magni in omnis molestias facilis.
        </p>
        <p>
