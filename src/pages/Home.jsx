  ...
  return (
    <>
      ...
      >
        ...
        <header className="Home-header dark:bg-text-dark dark:bg-opacity-30  bg-gradient-to-b from-transparent via-[rgba(255,255,255,0.2)] dark:via-[rgba(0,122,204,0.15)] to-transparent z-10 px-8 max-sm:px-4 py-4 pb-0 max-sm:py-0 relative ">
      ...
      <section
        id="Galeria"
        className="losowe-container m-8 max-sm:m-4 max-sm:mt-8 mb-4 max-sm:mb-2 relative"
      >
        <ImagesGrid />
      </section>
